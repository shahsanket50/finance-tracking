...
const EXPENSE_NAV: NavItem[] = [
  ...
  { label: 'Transactions', href: '/transactions',  glyph: '⇅', available: false },
...
const CA_NAV: NavItem[] = [
  ...
  { label: 'FY Checklist',  href: '/fy-checklist',  glyph: '☑', available: false },
  { label: 'Advance Tax',   href: '/advance-tax',   glyph: '◷', available: false },
  { label: 'Deductions',    href: '/deductions',    glyph: '−', available: false },
  { label: 'Capital Gains', href: '/capital-gains', glyph: '↗', available: false },
...
const SHARED_NAV: NavItem[] = [
  ...
  { label: 'Notifications', href: '/notifications', glyph: '◎', available: false },
      ...
      <nav className="nav-list">
        {contextNav.map((item) =>
          item.available ? (
            ...
            <span key={item.href} className="nav-item disabled" aria-disabled="true">
              <span className="nav-glyph">{item.glyph}</span>
              {item.label}
            </span>
          )
