...
statement data before Phase 3 closes. See PROJECT_STATE.md §Standing risks.
"""
...
REVERSAL_MATCH_WINDOW_DAYS: int = 3  # Reversals typically post within the same window as transfers
